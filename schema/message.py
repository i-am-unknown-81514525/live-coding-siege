...
sample = {
    ...
    "event": {
        ...
        "message": {
            "blocks": [
                {
                    ...
                    "elements": [
                        {
                            "elements": [{"text": "A huddle started", "type": "text"}],
            ...
            "channel": "C08SKC6P85V",
            "edited": {"ts": "1759867394.000000", "user": "USLACKBOT"},
...
class MessageData:
    ...
    def parse(cls, data: dict) -> Self:
        ...
        return cls(
            ...
            edited=Edited(
                user=edited_data["user"],
                ts=Arrow.fromtimestamp(float(edited_data["ts"])),
            )
            if edited_data
            else None,
...
class MessageEvent(Event):
    ...
    def parse(cls, data: dict):
        ...
        previous_message = (
            MessageData.parse(previous_message_data) if previous_message_data else None
        )
